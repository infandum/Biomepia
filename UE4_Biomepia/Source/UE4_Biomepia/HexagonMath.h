...
public:
	UFUNCTION(BlueprintPure, Category = "Hexagon Math")
		static FVector2D GetPositionOnCircle(float rad, float radius);
	...
	UFUNCTION(BlueprintPure, Category = "Hexagon Math")
		static TArray<FVector> GetHexagonTrapezoidsCenters(float radius, float height = 0, FVector position = FVector(0, 0, 0), bool isPointyHex = true);
